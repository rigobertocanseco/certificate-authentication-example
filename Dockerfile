...
COPY httpd/default-ssl.conf /etc/apache2/sites-available/
COPY httpd/ssl-params.conf /etc/apache2/conf-available/
COPY httpd/dir.conf /etc/apache2/mods-enabled/
